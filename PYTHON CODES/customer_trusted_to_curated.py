...
customer_trusted = glueContext.create_dynamic_frame.from_options(
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://vineethabuckets/customer_trusted/"], "recurse": True},
...
accelerometer_trusted = glueContext.create_dynamic_frame.from_options(
    connection_type="s3",
    format="json",
    connection_options={"paths": ["s3://vineethabuckets/accelerometer_trusted/"], "recurse": True},
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={"path": "s3://vineethabuckets/customer_curated/"},
    format="json"
)
